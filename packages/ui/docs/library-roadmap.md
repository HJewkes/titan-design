...
| 9 | Typography | `Typography` and `Eyebrow` move into `ui/`; re-export shims stay in `custom/`. Executed by the 2026-09-19 decision below (M2). |
...
| M2  | Typography to `ui/typography`, Eyebrow to `ui/eyebrow`, with a one-release re-export shim in `custom/Typography`    | Typography 68, Eyebrow 8 | now                                       |
