    ...
    <Page>
      <View style={{ gap: 4 }}>
        ...
        <Caption>
          ...
          driven by Workout Analytics.) Superseded by the LivePanelV2 composition, which pairs this with the velocity hero.
        </Caption>
      </View>
    ...
    <Page>
      <View style={{ gap: 4 }}>
        ...
        <Caption>
          ...
          chart owns the diverging tempo-adherence color, ROM stays parchment. See `Lab/North Star/4 · Fatigue System` →
          Live panel v2 for the composed, non-redundant version of this same pairing.
        </Caption>
      </View>
