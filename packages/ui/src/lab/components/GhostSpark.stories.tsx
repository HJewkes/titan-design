      ...
      <Page>
        <View style={{ gap: 4 }}>
          ...
          <Caption>
            ...
            card as the default (used in the North Star fatigue card, and in `SparkChart` above). Both shown revealed; at
            rest the labels drop and only the marks + line remain.
          </Caption>
        </View>
        <View style={{ flexDirection: 'row', gap: 24, alignItems: 'flex-start' }}>
