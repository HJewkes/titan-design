...
const MODS: Modality[] = [
  {
    ...
    strips: [
      ['in progress', 'g a a o o r t t t t'],
      ['planned', 't t t t t t t t t t'],
    ],
  },
  {
    name: 'Rep-range',
    ...
    strips: [
      ['done 10 / 8–12', 'g a a o o o r r a c'],
      ['planned', 't t t t t t t t c c c c'],
    ],
  },
  {
    name: 'AMRAP',
    ...
    strips: [
      ['in progress', 'g g a a o o o r r r c*'],
      ['planned 8+', 't t t t t t t t c*'],
    ],
  },
  {
    name: 'Drop set',
    ...
    strips: [
      ['done · 3 loads', 'g a o o r |a o r |o r'],
      ['loads', '120 → 100 → 80 lb'],
    ],
  },
  {
    ...
    strips: [
      ['in progress', 'g a a o o r |a o r |o r c*'],
      ['planned', 't t t t t t |t t t t t c*'],
    ],
  },
  {
    name: 'Cluster set',
  ...
  },
  {
    ...
    strips: [
      ['in progress', 'g g a a o o r c*'],
      ['stops at −20%', 'g g a a o o r r ✕'],
    ],
  },
]
      ...
      <View style={{ gap: 8, marginTop: 2 }}>
        {m.strips.map(([label, spec], i) => (
          <View key={i} style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
            <Text style={{ ...monoTag, color: T_TERTIARY, width: 92, textAlign: 'right' }}>
              {label}
            </Text>
    ...
    >
      <View style={{ flexDirection: 'row', gap: 14, flexWrap: 'wrap', maxWidth: 940 }}>
        ...
        <Principle
          ...
          body="AMRAP · the myo tail · a VBT velocity-stop carry a persistent cyan slot; new reps insert before it — it argues 'there's more'."
        />
      </View>
      ...
      >
        Open calls: how a drop set shows the WEIGHT drop (baseline step vs marker vs load labels) ·
        AMRAP (single trailing cyan) vs rep-range (bounded cyan window) distinctness · cluster
        (stays fast, no cyan) vs myo (decays, open cyan) · and which of these Voltras actually
        drives today.
      </Text>
    </Page>
  ),
