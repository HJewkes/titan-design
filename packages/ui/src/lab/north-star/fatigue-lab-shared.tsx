...
export const PAGE_BG = primitiveColors.charcoal[900]
export const PANEL_BG = primitiveColors.charcoal[800]
...
export const TEMPO_TUPLE: [number, number, number, number] = [TARGET.ecc / 1000, TARGET.pauseBottom / 1000, TARGET.con / 1000, TARGET.pauseTop / 1000]
...
export function HeroWithVlBands({ width, height = 300, current = 7 }: { width?: number; height?: number; current?: number }) {
...
export const FATIGUE_STATES: Array<{ name: string; current: number; aura: AuraCategory; read: FatigueRead }> = [
  {
    name: 'GOOD · early set',
    current: 1,
    aura: 'productive',
