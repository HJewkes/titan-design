...
export const lightThemeCSSVars = {
  ...
  '--color-status-deload': semanticColorsLight['status-deload'],
  ...
  '--color-brand-primary-solid': semanticColorsLight['brand-primary-solid'],
  '--color-brand-secondary-solid': semanticColorsLight['brand-secondary-solid'],
  '--color-status-success-solid': semanticColorsLight['status-success-solid'],
  '--color-status-error-solid': semanticColorsLight['status-error-solid'],
  '--color-status-warning-solid': semanticColorsLight['status-warning-solid'],
  '--color-status-info-solid': semanticColorsLight['status-info-solid'],
...
export const darkThemeCSSVars = {
  ...
  '--color-status-deload': semanticColorsDark['status-deload'],
  ...
  '--color-brand-primary-solid': semanticColorsDark['brand-primary-solid'],
  '--color-brand-secondary-solid': semanticColorsDark['brand-secondary-solid'],
  '--color-status-success-solid': semanticColorsDark['status-success-solid'],
  '--color-status-error-solid': semanticColorsDark['status-error-solid'],
  '--color-status-warning-solid': semanticColorsDark['status-warning-solid'],
  '--color-status-info-solid': semanticColorsDark['status-info-solid'],
