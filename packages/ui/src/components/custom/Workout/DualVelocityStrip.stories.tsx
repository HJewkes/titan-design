...
export const Hero: Story = {
  ...
  render: (args) => (
    <Page>
      <Panel width={760}>
        <Text style={{ color: '#fff', fontFamily: '"Space Grotesk", sans-serif', fontSize: 15, fontWeight: '700' }}>
...
export const RailExpanded: Story = {
  ...
  render: (args) => (
    <Page>
      <Panel width={320}>
        <Text style={{ color: '#fff', fontFamily: '"Space Grotesk", sans-serif', fontSize: 13, fontWeight: '700' }}>
