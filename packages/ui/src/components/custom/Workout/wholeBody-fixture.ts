...
const CUT: WholeBodyWeightRow = {
  ...
  direction: 'down',
  phase: { name: 'fat-loss' },
  latest: { value: 196.8, ts: '2026-09-18T12:00:00Z' },
...
const HOLD: WholeBodyWeightRow = {
  ...
  latest: { value: 181.2, ts: '2026-09-18T12:00:00Z' },
...
export const WHOLE_BODY_WEIGHT = {
  ...
  gain: {
    ...
    direction: 'up',
    phase: { name: 'gain' },
    latest: { value: 171.0, ts: '2026-09-18T12:00:00Z' },
  ...
  outsideHold: {
    ...
    latest: { value: 184.1, ts: '2026-09-18T12:00:00Z' },
    rate: {
      observedPctPerWeek: 0.6,
      bandLowPctPerWeek: null,
      bandHighPctPerWeek: null,
  ...
  slowLoss: {
    ...
    phase: { name: 'recomposition', slowLoss: true },
    latest: { value: 186.9, ts: '2026-09-18T12:00:00Z' },
  ...
  slowLossOneLine: {
    ...
    phase: { name: 'recomposition', slowLoss: true },
    latest: { value: 186.3, ts: '2026-09-18T12:00:00Z' },
  ...
  oneReading: {
    ...
    latest: { value: 200.0, ts: '2026-09-14T12:00:00Z' },
  ...
  rateVetoed: {
    ...
    phase: { name: 'fat-loss' },
    latest: { value: 198.2, ts: '2026-09-18T12:00:00Z' },
    week: { index: 1, of: 8, low: 199.0, high: 198.0 },
    rate: {
